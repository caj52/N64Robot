...
FINAL_IMAGE=${DISTDIR}/N64RumbleSwitch.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/N64RumbleSwitch.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC10F200
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/N64RumbleSwitch.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/N64RumbleSwitch.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC10F200 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/N64RumbleSwitch.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
